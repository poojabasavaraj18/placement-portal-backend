...
public class CDCService {
    ...
    public DashboardResponse getDashboardData() {
        ...
        for (Application app : applications) {
            ...
            switch (app.getStatus()) {
                ...
                case APPLIED ->
                    dto.setApplied(dto.getApplied() + 1);

                case ROUND1 ->
                    dto.setRound1(dto.getRound1() + 1);

                case ROUND2 ->
                    dto.setRound2(dto.getRound2() + 1);

                case SELECTED ->
                    dto.setSelected(dto.getSelected() + 1);
                ...
                // "Unexpected value: " + app.getStatus()
                // );
                ...
                default ->
                    System.out.println("Unknown status: " + app.getStatus());
            }
        }
        ...
        List<String> activities = applications.stream()
                ...
                .map(app -> {
                    ...
                    if (app.getJobPost() == null) {
                        return app.getName() + " applied";
                    }

                    return app.getName() + " applied for " +
                            app.getJobPost().getTitle();
                })
                .toList();
    ...
    public List<CDCApplicationDTO> getApplicationsByJob(Long jobId) {
        ...
        for (Application app : applications) {
            ...
            // Prevent NullPointerException
            if (app.getJobPost() != null &&
                    app.getJobPost().getId().equals(jobId)) {
    ...
    public List<JobSummaryDTO> getAllJobsWithCounts() {
        ...
        for (Application app : applications) {
            ...
            countMap.put(
                    jobId,
                    countMap.getOrDefault(jobId, 0L) + 1);
        }
